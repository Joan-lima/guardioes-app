...
export type Database = {
  public: {
    Tables: {
      ...
      events: {
        Row: { id: string; city_id: string | null; leader_id: string; title: string; event_date: string; location: string | null; description: string | null; is_official: boolean; qr_token: string; cancelled_at: string | null; created_at: string };
        Insert: Omit<Database['public']['Tables']['events']['Row'], 'id' | 'qr_token' | 'created_at'>;
